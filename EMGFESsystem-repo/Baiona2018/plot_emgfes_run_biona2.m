function plot_emgfes_run_biona2(aFES,rawProcSignal,trace_out)
% Plots the results of the Active FES run, for biona abstract - improved.
%
...
next_subplot=0;
nsubplots=4;%Total number of rows of subplot
figure
